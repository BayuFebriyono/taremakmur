        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-auto p-2">
                    ...
                    <input wire:model='namaSuplier' wire:change='cariSuplier' type="text" class="form-control mb-2"
                ...
                <div class="p-2">
                    <button wire:click='simpan' class="btn btn-ms btn-inverse-success" type="button">Simpan
                        Invoice</button>
                </div>
            </div>
