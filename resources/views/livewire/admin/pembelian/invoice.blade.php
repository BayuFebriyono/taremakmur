        ...
        <div class="card mt-4">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="p-2">
                        <button class="btn btn-ms btn-inverse-success" type="button">Simpan Invoice</button>
                    </div>
                </div>
                ...
                @if ($aktualId)
                        <div class="row my-3">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <button wire:click='cancelAktual' type="button" class="btn btn-sm btn-secondary">Cancel</button>
                            </div>
                        </div>
                @endif
                {{-- Remark --}}
                @if ($remarkId)
                        <div class="row my-3">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <button wire:click='cancelRemark' type="button" class="btn btn-sm btn-secondary">Cancel</button>
                            </div>
                        </div>
                @endif
                        ...
                        <tbody>
                            @foreach ($dataPembelian as $data)
                                <tr wire:key='{{ $data['id'] }}'>
                                    ...
                                    <td>{{ $data['diskon'] }}</td>
                                    <td wire:click='showRemark("{{ $data['id'] }}")' role="button" class="text-primary"><u>{{ $data['remark'] ?? '-' }}</u></td>
                                    <td>
